...
# Step 4: Ensemble Learning with Random Forest and Gradient Boosting
print("Step 4: Ensemble learning with Random Forest and Gradient Boosting...")
...
print("Step 5: Defining the neural network model...")
